    ...
    open: function (win, lose, args) {
        ...
        if (target === '_self' || !target) {
            ...
            if (!browserWrap) {
                ...
                browserWrap.style.backgroundColor = 'rgba(0,0,0,1)';
            ...
            if (features.indexOf('location=yes') !== -1 || features.indexOf('location') === -1) {
                popup.style.height = 'calc(100% - 55px)';
                popup.style.marginBottom = '0px';

                navigationButtonsDiv = document.createElement('div');
                navigationButtonsDiv.style.height = '60px';
                navigationButtonsDiv.style.backgroundColor = 'transparent';
                navigationButtonsDiv.style.zIndex = '999';
                navigationButtonsDiv.style.position = 'absolute';
                navigationButtonsDiv.style.bottom = '56px';
                ...
                //alert('str: '+strUrl);
                //if(strUrl.indexOf('/video.html') !== -1){
                  navigationButtonsDiv.class = 'close-video';
                //}
                ...
                navigationButtonsDivInner.style.backgroundColor = 'transparent';
                navigationButtonsDivInner.style.zIndex = '999';
                navigationButtonsDivInner.style['text-align'] = 'center';
