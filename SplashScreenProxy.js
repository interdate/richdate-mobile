...
// Default parameter values including image size can be changed in `config.xml`
  ...
  var bgColor = "#000000";
  var imageSrc = 'assets/img/splash.png';
  ...
  var SplashScreen = {
    ...
    show: function () {
      if(!localSplash) {
        ...
        localSplash.style["background-image"] = "url('assets/img/splash.png')";
        localSplash.style["background-size"] = "cover";
        localSplash.style["background-repeat"] = "no-repeat";
        localSplash.style["background-position"] = "center center";
